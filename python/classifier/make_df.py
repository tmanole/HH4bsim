...
#    tree.Add(temptree)
    ...
    for iEvt in list(range(iEvtStart,iEvtEnd)):
        ...
        if fromnp:
            ...
            jets[0].SetPtEtaPhiE(tree.jetPt0, tree.jetEta0, tree.jetPhi0, tree.jetEnergy0)
            jets[1].SetPtEtaPhiE(tree.jetPt1, tree.jetEta1, tree.jetPhi1, tree.jetEnergy1)
            jets[2].SetPtEtaPhiE(tree.jetPt2, tree.jetEta2, tree.jetPhi2, tree.jetEnergy2)
            jets[3].SetPtEtaPhiE(tree.jetPt3, tree.jetEta3, tree.jetPhi3, tree.jetEnergy3)
