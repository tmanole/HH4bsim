...
parser.add_argument('-po', '--pathout', default='../../events/MG1/PtEtaPhi/', type=str, help='Path to output directory.')
...
for i in range(tree.GetEntries()):
    ...
    for j in range(0, 4):
        ...
        #temp.append(vec2b[j].Rapidity())   # Toggle this line to use rapidity instead of pseudorapidity
        temp.append(tree.jetEta[j])         # Toggle this line to use pseudorapidity.
